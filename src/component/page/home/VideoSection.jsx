...
const VideoSection = () => {
    ...
    return (
        <div>
            <div className="px-10 bg-[#010E0E] pt-8 mt-20 pb-20">
                <h1 className=" text-[#ffffff] text-4xl pt-16 pb-6 font-bold">Looking to get away? Here are the <span className="text-[#E09B6B]">top Dream <br /> House</span> you shoud visit!</h1>
                <section className="bg-[#ffffff26] rounded-full mt-4 dark:bg-dark lg:pb-[36px]">
                        ...
                        <div className="-mx-4 flex flex-wrap justify-center">
                            <div className="w-full px-4">
                                <div className="relative z-20 h-[390px] overflow-hidden rounded-lg md:h-[550px]">
                                    <div className="absolute rounded-full left-0 top-0 h-full w-full">
                                        <img
                                            src="https://i.ibb.co/g3XSbxw/image-95.png"
                                            alt="bg"
                                            className="h-full rounded-full w-full object-cover object-center"
                                        />
                                    </div>
                                    <div
                                        className={`absolute left-0 top-0 z-10 flex h-full w-full items-center justify-center bg-[#ffffff00] `}
                                    >
                                        <a
                                            href="/#"
                ...
                <div>
                    <h1 className="text-white text-center text-8xl -mt-12">DREAM HOUSE</h1>
                </div>
            </div>
        </div>
    );
