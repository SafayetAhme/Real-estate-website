...
const Hero = () => {
    return (
        <div>
            <div className="bg-[#1D4734]  h-[780px]">
                <div>
                    <h1 className="font-primary font-bold text-8xl pt-10 pl-10 text-white">EXPERIENCE THE <br />EPITOME OF HOME <br />COMFORT.</h1>
                    <div className="px-10 grid grid-cols-2 pt-8 pb-12">
                        <div className="w-[300px] items-start">
                            <img className=" pl-[165px]" src="https://i.ibb.co/LzjJF4f/Group-427320621-2.png" alt="" />
                        </div>
                ...
                <img className="px-10 md:w-full mb-16 h-[460px]" src="https://i.ibb.co/8sjHnYq/image-93.png" alt="" />
            </div>
        </div>
    );
};
